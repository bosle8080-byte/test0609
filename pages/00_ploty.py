...
def load_data(tickers):
    ...
    # yfinance 버전에 따라 MultiIndex 또는 단일 Index 처리 분기
    ...
    if not df.empty:
        ...
        with tab1:
            ...
            for col in df_normalized.columns:
                ...
                fig_norm.add_trace(go.Scatter(x=df_normalized.index, y=df_normalized[col], mode='l', name=display_name))
        ...
        with tab2:
            ...
            for col in df.columns:
                display_name = [k for k, v in TOP_10_STOCKS.items() if v == col][0]
                fig_close.add_trace(go.Scatter(x=df.index, y=df[col], mode='l', name=display_name))
